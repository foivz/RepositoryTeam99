...
namespace Knjižnica
{
    public partial class FrmRegistracija : Form
    {
        ...
        {
            if (txtIme.Text != "".ToString() && txtPrezime.Text != "".ToString() && txtKorisnickoIme.Text != "".ToString() && txtLozinka.Text != "".ToString() && txtOib.Text != "".ToString() && txtEmail.Text != "".ToString() && txtBrojTelefona.Text != "".ToString())
            {
