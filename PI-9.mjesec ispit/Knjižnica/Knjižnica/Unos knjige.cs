...
namespace Knjižnica
{
    public partial class FrmUnosKnjige : Form
    {
        ...
        {
            if (txtGodinaIzdavanja.Text != "".ToString() && txtKolicina.Text != "".ToString() && txtNazivKnjige.Text != "".ToString() && txtSifraKnjige.Text != "".ToString())
            {
                ...
                using (var db = new piBazaEntities())
                {
                    ...
                    var upit6 = from a6 in db.lokacijaKnjige
                                where a == a6.idLokacije
                                select new
                    ...
                    knjiga k = new knjiga
                    {
                        ...
                        trenutnaKolicina = Convert.ToInt32(Kolicina.Text)
        ...
        private void Kolicina_TextChanged(object sender, EventArgs e)
        {

        }

        private void Kolicina_TextChanged_1(object sender, EventArgs e)
        {
