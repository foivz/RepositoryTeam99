...
namespace Knjižnica
{
    public partial class FrmClanarina : Form
    {
        ...
        {
            if (cmbKorisnickoIme.Text != "".ToString() && dtpDatumIsteka.Text != "".ToString() && dtpDatumPlacanja.Text != "".ToString() && txtCijena.Text != "".ToString())
            {
                MessageBox.Show("Uspješno ste napravili članarinu");
                using (var db = new piBazaEntities())
                {
                    ...
                    foreach (var c in querry)
                    {
...

                        {
                            ...
                            idClanarina = 100,
                            cijena =Convert.ToInt16( txtCijena.Text),
                        ...
                        this.clanarinaTableAdapter.FillBy(this.piBazaDataSet.clanarina, Convert.ToInt16(c.idKorisnika));
                        this.reportViewer1.RefreshReport();
                    }
